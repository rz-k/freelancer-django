    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=50, null=True), blank=True, null=True, size=5, verbose_name='مهارت های مورد نیاز')),
                ...
                ('military_status', models.CharField(choices=[('end_Soldeir', 'پایان خدمت'), ('soldier', 'سرباز'), ('exempt', 'معافیت'), ('no_matter', 'مهم نیست')], max_length=30, verbose_name='نظام وضیفه')),
