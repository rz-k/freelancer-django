# Generated by Django 3.2.9 on 2022-06-26 12:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=20, null=True), size=10), size=10)),
                ('approved', models.BooleanField(default=False, verbose_name='کاربر تایید شده توسط سایت')),
                ('cv', models.FileField(upload_to=account.models.cv_directory_path)),
