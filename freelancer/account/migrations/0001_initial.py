    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=11, null=True, verbose_name='شماره تلفن کاربر')),
                ('score', models.IntegerField(default=0, verbose_name='امتیاز کاربر')),
                ('balance', models.IntegerField(default=0, verbose_name='میزان حساب کاربر (ریال)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, null=True, verbose_name='توضیحات پروفایل')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to=freelancer.account.models.avatar_directory_path, verbose_name='عکس پروفایل')),
